...
int main ()
{
    ...
    oJson["message"]["basic_info"].Add ("author:ichard Stevens / Stephen A.Rago");
    oJson["message"]["basic_info"].Add ("publisher:人民邮电出版社");
    oJson["message"]["basic_info"].Add ("isbn:9787115147318");
